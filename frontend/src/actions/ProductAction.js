...
export const createProduct = (productData) => async (dispatch) => {
    try {
        ...
        const { data } = await axios.post(`${config.URL}/admin/product/new`, productData, configs)
...
export const updateProduct = (id, productData) => async (dispatch) => {
    try {
        ...
        const { data } = await axios.put(`${config.URL}/admin/product/${id}`, productData, configs)
...
export const deleteProduct = (id) => async (dispatch) => {
    try {
        ...
        const { data } = await axios.delete(`${config.URL}/admin/product/${id}`)
...
export const getAllReviews = (id) => async (dispatch) => {
    try {
        ...
        const { data } = await axios.get(`${config.URL}/reviews?id=${id}`)
...
export const deleteReviews = (reviewId, productId) => async (dispatch) => {
    try {
        ...
        const { data } = await axios.delete(`${config.URL}/reviews?id=${reviewId}&productId=${productId}`)
